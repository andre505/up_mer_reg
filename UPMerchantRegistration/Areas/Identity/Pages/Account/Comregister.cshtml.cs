...
namespace UPMerchantRegistration.Areas.Identity.Pages.Account
{
    ...
    public class ComregisterModel : PageModel
    {
        private readonly UPAGENTMANAGERContext _context;

        public ComregisterModel(UPAGENTMANAGERContext context)
        {
            _context = context;
        }
                ...
                if (response.success == "true")
                    try
                    {
                        ...
                        var agent = new Upagent
                        {
                            ...
                            Selectedshareholders = JSONproprietors,
