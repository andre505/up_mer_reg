...
//    {
//        public static MvcHtmlString Dropdown(string id, List<System.Web.Mvc.SelectListItem> selectListItems, string label)
//        {
...
//            items.(x => list.InnerHtml += "<li role=\"presentation\">" + BuildListRow(x) + "</li>");
